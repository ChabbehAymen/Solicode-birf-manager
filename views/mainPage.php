...
<body class="flex gap-4">
    <nav class="w-2/12 flex flex-column gap-3.5 shadow-sm border rounded h-full" style="padding:3vh;">
        ...
        <span class="hover:shadow rounded <?=!empty($_GET['page']) && $_GET['page'] === 'students'?'selected-tab':''?> p-2.5 flex text-blue-500 items-center gap-3" id="students">
