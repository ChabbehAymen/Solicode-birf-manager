<div class=" border border-gray-300 rounded-lg w-80">
    <div class="relative">
        ...
        <img class="rounded-t-lg" src="views/images/ClassImage.png" alt=""/>
    </div>
    <div class="p-5">
        ...
        <form action="" method="get">
            <button type="submit" name="idBrief" value="<?= $Realiser->ID_BRIEF ?>" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                View
            </button>
        </form>
    </div>
